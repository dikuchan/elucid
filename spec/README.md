...
|---|---|
| [Catalog](v0/catalog.md) | Sources, schemas, fields, inputs, ingestion-profile revisions, and declarative catalog application |
...
| [Ingestion](v0/ingestion.md) | HTTP ingestion requests, framing, normalization, idempotency, attempts, publication, and recovery |
